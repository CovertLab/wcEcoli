...
Endo-nucleolytic cleavage produces non-functional RNA fragments, which are then degraded to individual nucleotides via nine different exoRNases. Once degraded, these nucleotides can be recycled by the \textt{Metabolism} process.  ExoRNase capacity is determined as the following:
\begin{equation}
