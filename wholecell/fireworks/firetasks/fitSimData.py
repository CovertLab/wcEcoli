...
class FitSimDataTask(FireTaskBase):
	...
	optional_params = [
		...
		"disable_rnapoly_activity_fitting",
		...
		"forward_discrepancy_to_translation_efficiencies",
	...
	def run_task(self, fw_spec):
		...
		if self["fit_level"] == 1:
			...
			options = dict(
				...
				disable_rnapoly_activity_fitting=self['disable_rnapoly_activity_fitting'],
				...
				forward_discrepancy_to_translation_efficiencies=self['forward_discrepancy_to_translation_efficiencies'],
