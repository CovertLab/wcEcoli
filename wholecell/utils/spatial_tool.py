...
class SpatialMaster():
    ...
    def compute_diffusion_constant_from_mw(self, mw, mtype = 'protein',
                                           loc = 'nucleoid',
                                           temp = 300 * units.K,
        ...
        dc = self.compute_diffusion_constant_from_rp(rp,
                                           loc = loc,
                                           temp = temp,
                                           parameters = parameters)
        return dc

    def compute_diffusion_constant_from_rp(self, rp,
                                           loc = 'nucleoid',
                                           temp = 300 * units.K,
                                           parameters = (0.51, 0.53, 42, 10)):
        '''
