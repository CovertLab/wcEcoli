...
# Used for figure 2
DESC="SET C 4 gens 256 seeds 3 conditions with growth noise translation supply and D period" VARIANT="condition" FIRST_VARIANT_INDEX=0 LAST_VARIANT_INDEX=2 SINGLE_DAUGHTERS=1 N_GENS=4 N_INIT_SIMS=256 MASS_DISTRIBUTION=1 GROWTH_RATE_NOISE=1 D_PERIOD_DIVISION=1 python runscripts/fw_queue.py
...
# Used for figure 3
DESC="SET E 8 gens 8 seeds 10 weighting values" VARIANT="metabolism_kinetic_objective_weight" FIRST_VARIANT_INDEX=0 LAST_VARIANT_INDEX=9 SINGLE_DAUGHTERS=1 N_GENS=8 N_INIT_SIMS=8 MASS_DISTRIBUTION=1 GROWTH_RATE_NOISE=0 D_PERIOD_DIVISION=0 python runscripts/fw_queue.py
