...
DISABLE_RNAPOLY_ACTIVITY_FITTING = bool(int(os.environ.get("DISABLE_RNAPOLY_ACTIVITY_FITTING", "1")))
...
ALTERNATE_RNAP_ACTIVITY = bool(int(os.environ.get("ALTERNATE_RNAP_ACTIVITY", "0")))
...
fw_fit_level_1 = Firework(
	FitSimDataTask(
		...
		disable_rnapoly_activity_fitting = DISABLE_RNAPOLY_ACTIVITY_FITTING,
