...
PYTHONPATH=$PWD DESC="No tRNA Charging" SINGLE_DAUGHTERS=1 N_GENS=8 TRNA_CHARGING=0 COMPRESS_OUTPUT=1 PLOTS=ACTIVE python runscripts/fireworks/fw_queue.py
