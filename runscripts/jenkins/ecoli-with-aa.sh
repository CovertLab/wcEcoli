...
PYTHONPATH=$PWD DESC="With AAs." VARIANT="condition" FIRST_VARIANT_INDEX=3 LAST_VARIANT_INDEX=3 SINGLE_DAUGHTERS=1 N_GENS=8 MASS_DISTRIBUTION=0 COMPRESS_OUTPUT=1 PLOTS=ACTIVE RAISE_ON_TIME_LIMIT=1 python runscripts/fireworks/fw_queue.py
