#!/bin/sh
# Build the WCM Docker container images.
#
...
docker build -f container/runtime/Dockerfile -t wcm-runtime .

# Docker image #2: The Whole Cell Model code on the runtime environment.
# See this Dockerfile for usage instructions.
docker build -f container/wholecell/Dockerfile -t wcm-code .
