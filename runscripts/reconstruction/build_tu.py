...
Input (from transcription_units flat directory):
	tu.json - information about gene to transcription unit mapping generated from
		$PI_SCRATCH/mialy/TranscriptionUnitStructure/process_tu_matrix/create_sparse_tu_matrix.py
