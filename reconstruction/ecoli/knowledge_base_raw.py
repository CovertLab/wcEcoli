...
LIST_OF_DICT_FILENAMES = (
	...
	os.path.join("condition", "timeseries", "000007_basal_finite.tsv"),
	os.path.join("condition", "timeseries", "000008_glucose_absent_finite.tsv"),
	os.path.join("condition", "timeseries", "000009_aa_finite.tsv"),
	os.path.join("condition", "timeseries", "000010_oxygen_absent_finite.tsv"),
	os.path.join("condition", "timeseries", "000011_cut_glucose_finite.tsv"),
	os.path.join("condition", "timeseries", "000012_add_aa_finite.tsv"),
	os.path.join("condition", "timeseries", "000013_cut_oxygen_finite.tsv"),
