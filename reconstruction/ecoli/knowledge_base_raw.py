...
LIST_OF_DICT_FILENAMES = (
	...
	os.path.join("rna_seq_data","alternate_rna_seq_Cho.tsv"),
	os.path.join("rna_seq_data","alternate_rna_seq_Covert.tsv"),
	os.path.join("rna_seq_data","alternate_rna_seq_Dong.tsv"),
