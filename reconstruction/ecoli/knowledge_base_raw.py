...
LIST_OF_DICT_FILENAMES = (
	...
	os.path.join("condition", "timeseries", "000027_basal_finite.tsv"),
	os.path.join("condition", "timeseries", "000028_cut_glucose_finite.tsv"),
	os.path.join("condition", "timeseries", "000029_add_aa_finite.tsv"),
	os.path.join("condition", "timeseries", "000030_aa_finite.tsv"),
	os.path.join("condition", "timeseries", "000031_erantest.tsv"),
