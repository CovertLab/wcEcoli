...
LIST_OF_DICT_FILENAMES = (
	...
	os.path.join("condition", "environment", "M9.tsv"),
	os.path.join("condition", "environment", "M9_plus_glucose.tsv"),
	os.path.join("condition", "environment", "M9_plus_glucose_minus_oxygen.tsv"),
	os.path.join("condition", "environment", "M9_plus_glucose_plus_amino_acids.tsv"),
	os.path.join("condition", "timeseries", "000000_basal.tsv"),
	os.path.join("condition", "timeseries", "000001_glucose_absent.tsv"),
	os.path.join("condition", "timeseries", "000002_aa.tsv"),
	os.path.join("condition", "timeseries", "000003_oxygen_absent.tsv"),
	os.path.join("condition", "timeseries", "000004_cut_glucose.tsv"),
	os.path.join("condition", "timeseries", "000005_add_aa.tsv"),
	os.path.join("condition", "timeseries", "000006_cut_oxygen.tsv"),
	os.path.join("condition", "timeseries", "000007_basal_infinite.tsv"),
	os.path.join("condition", "timeseries", "000008_glucose_absent_infinite.tsv"),
	os.path.join("condition", "timeseries", "000009_aa_infinite.tsv"),
	os.path.join("condition", "timeseries", "000010_oxygen_absent_infinite.tsv"),
	os.path.join("condition", "timeseries", "000011_cut_glucose_infinite.tsv"),
	os.path.join("condition", "timeseries", "000012_add_aa_infinite.tsv"),
	os.path.join("condition", "timeseries", "000013_cut_oxygen_infinite.tsv"),
	os.path.join("condition", "timeseries", "000014_erantest.tsv"),
	)
