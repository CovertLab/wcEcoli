...
def fitKb_1(kb):
	...
	bulkAverageContainer, bulkDeviationContainer = calculateBulkDistribitions(kb)

	fitPpgppConcentation(kb, bulkAverageContainer)
...
def fitPpgppConcentation(kb, bulkAverageContainer):
