...
Clim_file = 'Clim11_STD_ratio_threshold_2_keep_NaNs_HL_cap_12.tsv'
...
OUTPUT_FILE_NAME = 'Clim11_STD_ratio_threshold_2_keep_NaNs_HL_cap_12.tsv' # e.g. 'protein_half_lives_Clim#.tsv'
...
def make_flat_file(Clim_file):
    ...
    with io.open(OUTPUT_PATH, 'wb') as f:
        ...
        for i in range(len(Clim_file)):
            writer.writerow([f'"{Clim_file["Monomer ID"][i]}"', f'{Clim_file["HL_value"][i]*60}'])
