...
get_current_EcoCyc_monomer_IDs_for_half_life_data.py (in the
...
# reconstruction/ecoli/scripts/clim_half_life_data/raw_protease_assignment_files folder)
...
# get_current_EcoCyc_monomer_IDs_for_protease_data.py.py
# to generate an updated comparison file
EcoCyc_file = \
...
# Note: this file name needs to also be manually added to the list in
# "knowledge_base_raw.py" in order to be used in the model
OUTPUT_FILE_NAME = 'protease_assignments.tsv' # e.g. 'protease_assignments_name.tsv'
...
raw_data_file_location = os.path.join(ROOT_PATH, 'reconstruction', 'ecoli',
                    'scripts', 'protein_half_lives', 'clim_half_life_data')
