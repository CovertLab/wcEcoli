...
# want to consider re-running this when the model updates accordingly.

# Previous monomer ID to Gupta et al. uniprot ID conversion files can be can be found in
# reconstruction/ecoli/scripts/clim_half_life_data/uniprot_id_to_ecocyc_monomer_id_matches
# and past protease assignments made using the data in the folder above can be found
# in reconstruction/ecoli/scripts/clim_half_life_data/post_flat_conversion_protease_assignments.
...
# TODO: update this file to read the Uniprot IDs directly from the .tsv files
#  once proteins.tsv is updated to include Uniprot IDs.
...
file_to_convert = '41467_2024_49920_MOESM5_ESM_ST2.xlsx'
# CHANGE THIS TO THE CURRENT DATE (in the form of DDMMYYYY)
date = input('Please enter the date in the form of DDMMYYYY, i.e.: "11202026":')
...
FullTable = FullTable[['Protein ID']]
...
rnasTable = pd.read_csv(
    'reconstruction/ecoli/flat/rnas.tsv', sep='\t',
                   skiprows=[0, 1, 2, 3, 4])
