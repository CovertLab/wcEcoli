...
get_current_EcoCyc_monomer_IDs_for_half_life_data.py (in the same folder as this file).
"""
...
# PATH TO THE SORTED INPUT FILE (in the clim_half_life_data/raw_clim_sorts folder)
...
# get_current_EcoCyc_monomer_IDs_for_half_life_data.py to get an updated comparison file
EcoCyc_file = \
...
# "knowledge_base_raw.py" to be used in the model!
OUTPUT_FILE_NAME = 'protein_half_lives_name.tsv' # e.g. 'protein_half_lives_name.tsv'
...
def get_monomer_ID(EcoCyc_file, Clim_file):
    ...
    for i in range(len(Clim_file)):
        ...
        monomer_row = EcoCyc_file[EcoCyc_file['Gupta et al. 2024 Protein ID']
                                  == Clim_file['Protein ID'][i]]
