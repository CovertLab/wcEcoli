...
def main(simOutDir, plotOutDir, plotOutFileName, simDataFile, validationDataFile, metadata = None):
	...
	plt.figtext(0,1,fluxNamesEstimates)
	...
	# n, bins, patches = plt.hist(reactionRatesUnconstrained, 50, normed=True)
	
	# plt.xlabel('Flux (uM/s)')
	# plt.ylabel('Frequency')
	# plt.title('Histogram of unconstrained jFBA fluxes')
