...
def main(simOutDir, plotOutDir, plotOutFileName, simDataFile, validationDataFile, metadata = None):
	...
	lines = axarr[0].plot(t / 60., masses, linewidth = 2)
	axarr[0].set_xlim(0, t.shape[0])
	...
	rects = barax.bar(range(1, num_x+1), relativeRates[0,:],  align='center', color='purple', alpha=.7, label="Fold Difference")
