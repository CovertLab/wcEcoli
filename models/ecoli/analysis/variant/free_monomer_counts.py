"""
Plot mRNA and free monomer counts for proteins across multiple generations
and variants.
...
class Plot(variantAnalysisPlot.VariantAnalysisPlot):
	def seed_plot(self, control_var, experimental_vars):
		...
		Returns: A plot of the protein counts and mRNA counts for each of
		...
		ax[0].set_ylabel("Free Monomer Counts")
