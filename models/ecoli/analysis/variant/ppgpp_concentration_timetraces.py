"""
Compares timetraces of ppGpp concentrations across different variants.
"""
...
class Plot(variantAnalysisPlot.VariantAnalysisPlot):
	def do_plot(self, inputDir, plotOutDir, plotOutFileName, simDataFile, validationDataFile, metadata):
		...
		for variant in variants:
			...
			# Get timetraces of ppGpp concentrations from each seed in this
			# variant
			...
			variant_to_all_timetraces[variant] = all_ppgpp_timetraces
			variant_to_swa_timetrace[variant] = swa_ppgpp_timetrace
			variant_to_t_max[variant] = t_max

		plt.figure(figsize=(10, 3))
		ax1 = plt.subplot(1, 1, 1)

		# Plot timetraces of ppGpp concentrations from each variant on one plot
