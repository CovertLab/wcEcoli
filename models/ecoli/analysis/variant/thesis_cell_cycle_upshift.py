...
def main(inputDir, plotOutDir, plotOutFileName, validationDataFile = None, metadata = None):
	...
	ax1 = plt.subplot2grid((5,1), (1,0), sharex=ax0)
	ax2 = plt.subplot2grid((5,1), (2,0), sharex=ax0)
	ax3 = plt.subplot2grid((5,1), (3,0), sharex=ax0)
	ax4 = plt.subplot2grid((5,1), (4,0), sharex=ax0)
