...
This is essentially the same script as proteomics_fluxomics_comparison.py, but
is not specific to operons on vs. off comparisons.
"""
...
class Plot(comparisonAnalysisPlot.ComparisonAnalysisPlot):
	def do_plot(self, reference_sim_dir, plotOutDir, plotOutFileName, input_sim_dir, unused, metadata):
		# From fw_queue, both sims have operons="on".
		# reference_sim_dir and input_sim_dir are two different sets of sims.
		...
		plot_flux(
			ax2, sim1_flux_mean, sim2_flux_mean, sim1_flux_std, sim2_flux_std,
			flux_pearson)

		out_file_name = \
			f"{plotOutFileName[:-9]}_{reference_sim_name}_vs_{input_sim_name}"
