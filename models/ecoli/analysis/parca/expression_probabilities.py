...
class Plot(parcaAnalysisPlot.ParcaAnalysisPlot):
	def do_plot(self, input_dir, plot_out_dir, plot_out_filename, sim_data_file, validation_data_file, metadata):
		...
		ax.set_yscale('symlog', linthresh=min_basal)
		...
		ax.set_yscale('symlog', linthresh=min_ppgpp)
		ax.spines['top'].set_visible(False)
		ax.spines['right'].set_visible(False)
		ax.tick_params(labelsize=6, bottom=False, labelbottom=False)
		ax.set_xlabel('Sorted genes')
		...
		ax.set_yscale('symlog', linthresh=min_val)
		ax.spines['top'].set_visible(False)
		ax.spines['right'].set_visible(False)
		...
		ax.set_yscale('symlog', linthresh=np.min(np.abs(reg_v[np.abs(reg_v) > 0])))
		ax.spines['top'].set_visible(False)
		ax.spines['right'].set_visible(False)
		ax.tick_params(labelsize=6, bottom=False, labelbottom=False)
		ax.set_xlabel('Sorted genes')
