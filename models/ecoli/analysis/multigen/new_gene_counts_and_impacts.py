...
class Plot(multigenAnalysisPlot.MultigenAnalysisPlot):
	...
	def do_plot(self, seedOutDir, plotOutDir, plotOutFileName, simDataFile,
		...
		for i in range(len(plot_suffixes)):
			...
			# 	cell_paths, "RNACounts", "partial_mRNA_counts",
			# 	ignore_exception=True)[:, rnap_subunit_mRNA_indexes], axis=1)
			...
			# 	cell_paths, "RNACounts", "partial_mRNA_counts",
			# 	ignore_exception=True)[:, ribosomal_mRNA_indexes], axis=1)
			...
			# 	ignore_exception=True)[:, new_gene_monomer_indexes]
			...
			# 	cell_paths, "RibosomeData", "n_ribosomes_per_transcript",
			# 	ignore_exception=True)[:, rnap_subunit_monomer_indexes], axis=1)
			...
			# 	cell_paths, "RibosomeData", "n_ribosomes_per_transcript",
			# 	ignore_exception=True)[:, ribosomal_monomer_indexes], axis=1)
