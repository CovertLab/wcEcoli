...
# From max constraint * 1 on Sherlock
REACTION_CATALYST_PAIRS = [
	...
	('F16ALDOLASE-RXN__FRUCBISALD-CLASSII', 'FRUCBISALD-CLASSII[c]'),
	('DIHYDROOROT-RXN', 'DIHYDROOROT-CPLX[c]'),
	('PABASYN-RXN', 'PABASYN-CPLX[c]'),
	('NACGLCTRANS-RXN (reverse)', 'NACGLCTRANS-MONOMER[m]'),
	('RXN-16701 (reverse)', 'PGLYCDEHYDROG-CPLX[c]'),
	('RXN-16701', 'PGLYCDEHYDROG-CPLX[c]'),
	('PSERTRANSAM-RXN', 'PSERTRANSAM-CPLX[c]'),
