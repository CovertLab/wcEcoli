...
class Plot(multigenAnalysisPlot.MultigenAnalysisPlot):
	...
	def do_plot(self, seedOutDir, plotOutDir, plotOutFileName, simDataFile,
		...
		rna_idx_where_updated_yes_gfp_greater = np.where(np.any(basal_probs_updated_yes_gfp >= basal_probs_updated_no_gfp * 0.50, axis=0))[0]
		counts_rna_idx_where_updated_yes_gfp_greater = np.sum(basal_probs_updated_yes_gfp >= basal_probs_updated_no_gfp * 0.50, axis=0)
