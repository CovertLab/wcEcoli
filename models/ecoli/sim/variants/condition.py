...
def condition(sim_data, index):
	...
	if sim_data.external_state.environment.conditions[condition_label]["nutrients"] == "minimal_plus_amino_acids":
		sim_data.external_state.environment.nutrients_time_series_label = "000003_aa"
	elif sim_data.external_state.environment.conditions[condition_label]["nutrients"] == "minimal_minus_oxygen":
