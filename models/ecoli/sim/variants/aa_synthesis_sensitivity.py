...
Expected variant indices (dependent on length of FACTORS and sim_data.molecule_groups.amino_acids):
	0-7: range of values for first parameter, first amino acid, first media condition
	0-39: range of parameters and values for first amino acid, first media condition
	0-839: range of parameters and values over all amino acids for first media condition
	0-1679: all changes
"""
