...
class MetabolismExternalPathway(wholecell.processes.process.Process):
    ...
    def initialize(self, sim, sim_data):
        ...
        if sim_data.process.metabolism_external_pathway.has_external_pathway==True:
            ...
            self.external_pathway_exists = False
    ...
    def calculateRequest(self):
        if self.external_pathway_exists:
            ...
            dry_mass = (self.readFromListener("Mass", "dryMass") * units.fg).asNumber(units.g)
            ...
            self.molecules_required, self.all_molecule_changes, self.flux = self.molecules_to_next_time_step(
                ...
                self.cell_volume, self.n_avogadro, 10000,
