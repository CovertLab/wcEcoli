...
def TU_to_operons(operon_rnas):
    ...
    for line in rna_deg_data[1:]:
        ...
        for x in operon_gene_ids:
            rna_counts.append(gene_to_count[x])

        rna_ratio = gene_to_count[rna_deg_dict[name]['stabilized gene']]/np.mean(rna_counts)
...
if __name__ == "__main__":
    TU_to_operons('reconstruction/ecoli/flat/operon_rnas.tsv')
